...
ruta="C:\\Users\\warner\\Desktop\\modulos\\metacriticScores\\metacriticScores\\bin\\Debug\\netcoreapp3.1\\metacriticScores.exe"
...
def tarea(args):
    ...
    socketIO.emit('finMetacriticScore',args)  #emite evento para decirle al server que ya termino la tarea

socketIO = SocketIO("http://localhost",5000) #se conecta al server
socketIO.on('onMetacriticScore', tarea)  # define que hacer cuando se actice el evento
